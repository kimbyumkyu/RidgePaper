...
Finally, the ridge yields as functions of the minimum $\ptlead$ ($\it{p}^{\rm{Lead}}_{\rm{T,min}}$) and $\ptjet$ ($\it{p}^{\rm{Jet}}_{\rm{T,min}}$) selections are shown in Fig.~\ref{fig:RidgeYield_ESE}. The ridge yield increases with increasing $\it{p}^{\rm{Lead}}_{\rm{T,min}}$ or $\it{p}^{\rm{Jet}}_{\rm{T,min}}$. $\pythiashoving$ underestimates the ridge yield with the increasing $\it{p}_{\rm{T,Lead}}$ or $\it{p}_{\rm{T,Jet}}$, still holding presence of the ridge. $\pythiam$ does not produce the ridge yield, estimating zero yield, which imply the negligible jet contamination in the measurements.
